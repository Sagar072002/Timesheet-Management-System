...
const Employee = () => {
  ...
  return (
    <div className="back  w-full p-4 pt-7">
      ...
      <div className="">
    <div className="">
  <h1 className="uppercase text-center pt-4 text-3xl font-extrabold text-gray-900  md:text-5xl lg:text-5xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-500 from-sky-500">Employee Dashboard</span> </h1>
